...
<html>
	...
	<body>
		<a href="/<?php echo $root; ?>/PayHost/singleVault/cardVault/index.php">Back to Card Vault</a>
		<br>
		<form role="form" class="form-horizontal text-left" action="simple_cardVault.php" method="post">
			...
			<input class="form-control" type="text" name="expiryDate" id="expiryDate" value="<?php echo(isset($expiryDate) ? $expiryDate : ''); ?>" /> (mmYYYY)
			<br>
			<?php
				$j = 1;
				while($j >= 1){
