...
<html>
	...
	<body>
		<a href="/<?php echo $root; ?>/PayHost/singleVault/deleteVault/index.php">Back to Delete Vault</a>
		<br>
		<form role="form" class="form-horizontal text-left" action="simple_deleteVault.php" method="post">
