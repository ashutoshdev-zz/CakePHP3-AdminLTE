...
<?php 
            echo $this->Form->input('username',array('class'=>'form-control','required')); 
            ...
            echo $this->Form->input('zip',array('class'=>'form-control','label'=>'Address(for vendor)','required','id'=>'searchTextField'));
            echo $this->Form->input('radius',array('class'=>'form-control','label'=>'Delivery Range(In miles)(for vendor)','required'));
