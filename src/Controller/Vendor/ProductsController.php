...
class ProductsController extends AppController
{
    ...
    public function index()
    {
       $this->loadModel('Products');
        $products = $this->Products->find('all', [
            'conditions' => ['Products.user_id' =>$this->Auth->User('id') ], 'contain' => ['SubscriptionPlans', 'Days', 'Categories']
        ]);    
    ...
    public function add()
    {
        ...
        $users = $this->Products->Users->find('list', ['conditions' => ['Users.id'=>$this->Auth->user('id')]]);
       ...
       // $subcategories = $this->Products->Subcategories->find('list', ['limit' => 200]);
        $assoproducts = $this->Products->AssoProducts->find('list',['conditions' => ['AssoProducts.user_id'=>$this->Auth->user('id')]]);
        $this->set(compact('product', 'subscriptionPlans', 'users', 'alergies', 'days', 'categories','assoproducts'));
        $this->set('_serialize', ['product']);
    }
