        ...
        if ($ven_id) {
            ...
            $days = $this->Days->find('all')->contain(['Products' => function ($q) {
                    ...
                    public function myaccount() {
                        ...
                        $User = $query->first();
                        if ($User->my_r_code == '') {
                            $pcode = strtoupper($User->fname . '-' . substr(base_convert(sha1(uniqid(mt_rand())), 16, 36), 0, 3));
                                                ...
                                                if ($this->request->is('post')) {
                                                    if ($_POST['fname'] == '') {
                                                        ...
                                                        if ($this->Users->save($user)) {
                                                            ...
                                                            $email->from(['plait@ashutosh.crystalbiltech.com' => 'Plait'])
                                                                    ->emailFormat('html')
                                            ...
                                            public function forgetpassword() {
                                                ...
                                                if (empty($email)) {
                                                    ...
                                                    if ($data->username) {
                                                        ...
                                                        $email = new Email('default');
                                                        $email->from(['pliat@ashutosh.crystalbiltech.com' => 'Plait'])
                                                                ->emailFormat('html')
                                                                ->template('default', 'default')
                                                                ->to($data->username)
