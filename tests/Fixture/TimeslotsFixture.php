...
class TimeslotsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'timeslot' => ['type' => 'string', 'length' => 250, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'category_id' => 1,
            'created' => '2017-01-02 14:33:00',
            'modified' => '2017-01-02 14:33:00'
        ],
    ];
}
