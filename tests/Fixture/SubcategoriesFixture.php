...
class SubcategoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'is_main' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'category_id' => 1,
            'status' => 1,
            'created' => '2016-12-16 13:55:51',
            'modified' => '2016-12-16 13:55:51',
            'is_main' => 1
        ],
    ];
}
