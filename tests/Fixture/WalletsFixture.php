...
class WalletsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'points' => ['type' => 'string', 'length' => 250, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2017-01-10 05:59:13',
            'modified' => '2017-01-10 05:59:13'
        ],
    ];
}
