...
class OrderItemsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'image' => ['type' => 'string', 'length' => 250, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'quantity' => 1,
            'created' => '2016-12-12 14:30:07',
            'modified' => '2016-12-12 14:30:07'
        ],
    ];
}
