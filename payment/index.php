...
$sql = "SELECT * FROM carts WHERE id='".$_POST['cart_id']."'";
...
<form role="form" class="form-horizontal text-left" action="index.php" method="post" id="paymentfrom">
    ...
    <input style="display: none;" class="form-control" type="text" name="retUrl" id="retUrl" value="http://plait.co.za/plait/users/paymentreturn" />
